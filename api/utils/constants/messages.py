...
PROJECT_NOT_FOUND = "The project with the specified id could not be found."
...
PROJECT_TITLE_TAKEN = "The project title you specified is already taken."
BLOG_TITLE_EMPTY = "Blog title can not be empty."
PROJECT_TITLE_EMPTY = "Project title can not be empty."
PROJECT_GITURL_EMPTY = "Project git url can not be empty."
BLOG_TOPIC_EMPTY = "Blog topic can not be empty."
